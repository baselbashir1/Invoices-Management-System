                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    @php
                                        $i++;
                                    @endphp
                                    <tr class="invoiceRow{{ $invoice->id }}">
                                        <td>{{ $i }}</td>
                                            ...
                                            @can('العمليات')
                                                <div class="dropdown">
                                                    <button aria-expanded="false" aria-haspopup="true"
                                                        ...
                                                        type="button"><i class='bx bxs-cog'></i></button>
                                                    <div class="dropdown-menu tx-13">
                                                        @can('تعديل الفاتورة')
                                                            <a class="dropdown-item"
                                                                href="{{ url('edit_invoice') }}/{{ $invoice->id }}">
                                                                <i class='text-primary bx bxs-edit'></i>&nbsp;&nbsp;
                                                                تعديل الفاتورة
                                                            </a>
                                                        @endcan
                                                        @can('حذف الفاتورة')
                                                        ...
                                                        @can('ارشفة الفاتورة')
                                                            <a class="dropdown-item" href="#"
                                                                ...
                                                                <i class='text-warning bx bxs-archive-in'></i>&nbsp;&nbsp;
                                                                ارشفة الفاتورة
                                                            </a>
                                                        @endcan
                                                        @can('طباعة الفاتورة')
    ...
    <div class="modal fade" id="delete_invoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('invoices.destroy', 'fail') }}" method="post">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
